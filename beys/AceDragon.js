...
class AceDragon extends Beyblade {
    constructor(e,s){super("Ace Dragon","Attack","https://vignette.wikia.nocookie.net/beyblade/images/4/4e/BBGT_Ace_Dragon_Sting_Charge_Zan_Beyblade.png/revision/latest?cb=20190401120826",e,s),
        this.specials=[{name:"Special",requires:function(e,s,t){return e.sp>3},execute:function(e,s,t){s.hp=s.hp-49;let a=(new Discord.MessageEmbed).setTitle(`[${e.username}] Ace Dragon used **Dragon Shoot**. 49 damage dealt.`).setColor("#551a8b");t.channel.send(a)}}],
